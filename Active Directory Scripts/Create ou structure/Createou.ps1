<#
.SYNOPSIS
  This script can be used to create an ou strucutre
.DESCRIPTION
...
.EXAMPLE
  .\createout -ouname (name of ou) -oupath (format in the following format "OU=Regions,OU=Managers,DC=Enterprise,DC=Com")
